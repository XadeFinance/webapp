    ...
    <>
     ...
     <div className = {styles3.contentWrapper}>
        ...
        <>
          ...
          <div className={styles3.contentWrapper}>
            <p className={tickStyles.and}> Deposit successful! </p>
          </div>
          ...
          <div className={styles3.contentWrapper}>
            <div className={styles3.information}>
              ...
              <p
                onClick={() =>
                  alert("0x7765e4256e0dBda401Ce64809bAB5AefDca40F08")
                }
                className={styles3.informationInformation}
              >
                {"0x7765e4256e0dBda401Ce64809bAB5AefDca40F08".slice(0, 6)}...
                {"0x7765e4256e0dBda401Ce64809bAB5AefDca40F08".slice(-3)}
              </p>
            </div>
          </div>
